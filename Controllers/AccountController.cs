    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(string returnUrl)
        {
            ...
            if (UserManager.Users.Count() == 0)
            {
                ...
                await UserManager.AddClaimAsync(user.Id, new Claim(ClaimTypes.GivenName, "Clerk"));
                await UserManager.AddClaimAsync(user.Id, new Claim(ClaimTypes.Surname, "Executive"));
            }
